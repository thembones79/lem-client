...
- new big functionality - `order statistics` dashboard page (orders list with sorting, filtering and counting + order details with extendable hourly pace according to lines used)
